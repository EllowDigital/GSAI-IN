...
export default function LocationSection() {
  return (
    <section id="location" className="py-10 xs:py-16 px-2 xs:px-4 bg-gray-100">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Google Map Embed */}
        <div className="relative w-full h-52 xs:h-72 md:h-96 shadow-md rounded-lg overflow-hidden">
          <iframe
