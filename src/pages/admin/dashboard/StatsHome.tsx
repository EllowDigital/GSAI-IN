    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="bg-white shadow-md rounded-lg overflow-hidden">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{isLoading ? '...' : counts?.students || 0}</div>
        ...
        <Card className="bg-white shadow-md rounded-lg overflow-hidden">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{isLoading ? '...' : counts?.blogs || 0}</div>
        ...
        <Card className="bg-white shadow-md rounded-lg overflow-hidden">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{isLoading ? '...' : counts?.events || 0}</div>
        ...
        <Card className="bg-white shadow-md rounded-lg overflow-hidden">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{isLoading ? '...' : counts?.gallery_images || 0}</div>
