        ...
        >
          ...
          >
            ...
            <div className={cn(
              ...
              isLogin ? "bg-[radial-gradient(circle_at_center,hsl(var(--primary))_0%,transparent_70%)]" 
                      : "bg-[radial-gradient(circle_at_center,hsl(var(--destructive))_0%,transparent_70%)]"
            )} />

            {/* Icon Container */}
            <motion.div variants={itemVariants} className="relative mx-auto w-16 h-16 mb-6">
              <div className={cn(
              ...
              <div className={cn(
                ...
                isLogin ? "bg-primary/10 text-primary border border-primary/20" 
