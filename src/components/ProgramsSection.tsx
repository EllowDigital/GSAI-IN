...
export default function ProgramsSection() {
  return (
    <section id="programs" className="bg-gray-900 py-14 xs:py-16 px-2 xs:px-4">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-2xl xs:text-3xl md:text-4xl font-bold text-yellow-400 mb-6 xs:mb-8 tracking-wide text-center">
          🥋 Programs &amp; Training
        </h2>
        <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 xs:gap-8">
          {programs.map((prog, i) => (
            <motion.div
              key={prog.title}
              className="bg-white rounded-xl shadow-md p-5 xs:p-6 flex flex-col items-center justify-center transition-transform hover:scale-105 hover:shadow-lg cursor-pointer"
              initial="offscreen"
            ...
            >
              ...
              <h3 className="font-extrabold text-base xs:text-lg text-gray-800 mb-1">
                {prog.title}
              </h3>
