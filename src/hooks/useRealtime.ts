  ...
  useEffect(() => {
    const channels = [
      ...
      supabase
        ...
        .on('postgres_changes', { event: '*', schema: 'public', table: 'student_programs' }, () => {
      ...
      supabase
        ...
        .on('postgres_changes', { event: '*', schema: 'public', table: 'promotion_history' }, () => {
      ...
      supabase
        ...
        .on('postgres_changes', { event: '*', schema: 'public', table: 'student_discipline_progress' }, () => {
      ...
      supabase
        ...
        .on('postgres_changes', { event: '*', schema: 'public', table: 'belt_levels' }, () => {
