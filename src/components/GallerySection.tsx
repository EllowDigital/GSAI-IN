      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        {loading ? (
          ...
          >
            ...
            <h3 className="text-3xl font-bold text-gray-400 mb-4">No Images Yet</h3>
            <p className="text-xl text-gray-500">Check back soon for amazing moments from our academy!</p>
          </motion.div>
        ) : (
          <motion.div
