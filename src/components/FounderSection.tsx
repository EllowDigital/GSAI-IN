    ...
    >
      <div className="max-w-3xl mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-12 bg-white/90 shadow-lg rounded-2xl p-6 xs:p-8 md:p-10">
        ...
        <div className="flex-1 w-full md:w-auto">
          <div className="flex items-center justify-center md:justify-start mb-2 xs:mb-3">
            <User className="text-yellow-400 mr-2" size={24} />
            <h2 className="text-2xl xs:text-3xl md:text-4xl font-extrabold text-gray-800 tracking-tight text-center md:text-left">
          ...
          <blockquote className="border-l-4 border-yellow-400 pl-4 py-2 italic text-base xs:text-lg font-semibold text-yellow-900 bg-yellow-100/60 rounded mb-4 text-center md:text-left">
            <span>
