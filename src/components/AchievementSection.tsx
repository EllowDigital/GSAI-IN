...
import { Award, Medal, Trophy, Sparkles, Star, Target, Crown } from 'lucide-react';
...
const achievements = [
  {
    ...
    description: 'Anant Sahu secured gold with exceptional skill and dedication at the national level competition.',
  ...
  },
  {
    ...
    description: 'Awarded for innovative technique and flawless execution in martial arts demonstration.',
    category: 'Excellence',
    year: '2024',
  ...
  },
  {
    ...
    description: 'Nitesh Yadav received global acclaim at a prestigious international martial arts competition.',
    category: 'Global',
    year: '2023',
  ...
  },
  {
    ...
    description: 'Outstanding young talent recognition for exceptional performance and dedication to martial arts.',
    category: 'Youth',
    year: '2024',
  ...
  },
  {
    ...
    description: 'Perfect score achievement in accuracy and precision during competitive martial arts evaluation.',
  ...
  },
  {
    ...
    description: 'Ghatak Sports Academy recognized as the leading martial arts training center in the region.',
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-3 mb-6">
            ...
            <span className="text-lg font-semibold text-yellow-600 tracking-wide">Excellence & Recognition</span>
          </div>

          <h2 id="achievements-heading" className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            Our{' '}
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
            Celebrating proud moments and milestones achieved by our dedicated athletes and academy, 
            showcasing excellence in martial arts and character development.
          </p>
            ...
            >
              ...
              <div className="relative z-10 p-6 lg:p-8">
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className={`w-16 h-16 ${achievement.iconBg} rounded-xl flex items-center justify-center text-white shadow-lg transform group-hover:scale-110 transition-transform duration-300`}>
                    {achievement.icon}
                  </div>
                  <div className="text-right">
                    ...
                    <div className="text-sm font-bold text-gray-500">{achievement.year}</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2 pt-4 border-t border-gray-100 group-hover:border-yellow-200 transition-colors duration-300">
                  ...
                  <span className="text-sm font-semibold text-gray-700 ml-2">Excellence Rating</span>
                </div>
              ...
              <div className={`absolute inset-0 border-2 border-transparent bg-gradient-to-r ${achievement.color} rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500`} style={{ padding: '2px' }}>
        ...
        >
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="text-center p-6 bg-white/80 backdrop-blur-sm rounded-xl border border-gray-200/50 shadow-sm">
              ...
              <div className="text-sm text-gray-600 font-medium">Championships</div>
            </div>
            <div className="text-center p-6 bg-white/80 backdrop-blur-sm rounded-xl border border-gray-200/50 shadow-sm">
              <div className="text-3xl font-bold text-blue-600 mb-2">200+</div>
              <div className="text-sm text-gray-600 font-medium">Competitions</div>
            </div>
            <div className="text-center p-6 bg-white/80 backdrop-blur-sm rounded-xl border border-gray-200/50 shadow-sm">
