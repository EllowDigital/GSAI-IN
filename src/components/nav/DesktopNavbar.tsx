  ...
  return (
    <>
      ...
      <div className="hidden lg:flex items-center justify-between px-6 py-4">
        {/* Logo Section */}
        <Link to="/" className="flex items-center space-x-4 group" aria-label="Go to homepage">
        ...
        {/* Navigation Links */}
        <nav className="flex items-center space-x-8" role="menubar" aria-label="Primary navigation">
      ...
      <div className="hidden md:flex lg:hidden items-center justify-between px-6 py-3">
        ...
        <Link to="/" className="flex items-center space-x-3 group" aria-label="Go to homepage">
          ...
          />
          <div className="flex flex-col">
            <span className="text-base font-bold text-gray-900 group-hover:text-red-600 transition-colors duration-300">GSAI</span>
