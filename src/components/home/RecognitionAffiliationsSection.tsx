...
const logos = [
  {
    ...
    url: '/assets/affiliations/india.png',
    category: 'government',
  },
  {
    name: 'Ministry of Youth Affairs & Sports',
    url: '/assets/affiliations/ministry.png',
    category: 'government',
  },
  {
    name: 'Fit India',
    url: '/assets/affiliations/fit-india.png',
    category: 'fitness',
  },
  {
    name: 'Khelo India',
  ...
  { name: 'SGFI', url: '/assets/affiliations/SGF.png', category: 'federation' },
  {
    name: 'UP Olympic Association',
    url: '/assets/affiliations/up-olympic.png',
    category: 'sports',
  },
  {
    name: 'UP Kalaripayattu Federation',
    url: '/assets/affiliations/up-kalarippayattu.png',
    category: 'federation',
  },
  {
    name: 'Taekwondo Federation',
    url: '/assets/affiliations/takewondo.png',
    category: 'federation',
  },
  {
    name: 'Indian Kalaripayattu Federation',
    url: '/assets/affiliations/in-kalarippayattufed.png',
    category: 'federation',
  },
];
