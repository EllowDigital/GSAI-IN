...
function getDashboardAdminTitle(pathname: string): string {
  if (pathname === '/admin/dashboard')
    return 'Admin Dashboard | GSAI Admin Portal';
  if (pathname.startsWith('/admin/dashboard/enrollments'))
    return 'Enrollment Requests | GSAI Admin Portal';
  if (pathname.startsWith('/admin/dashboard/students'))
    return 'Students | GSAI Admin Portal';
  if (pathname.startsWith('/admin/dashboard/fees'))
    return 'Fees Manager | GSAI Admin Portal';
  if (pathname.startsWith('/admin/dashboard/progression'))
    return 'Progression | GSAI Admin Portal';
  if (pathname.startsWith('/admin/dashboard/disciplines'))
    return 'Disciplines | GSAI Admin Portal';
  if (pathname.startsWith('/admin/dashboard/events'))
    return 'Events | GSAI Admin Portal';
  if (pathname.startsWith('/admin/dashboard/competitions'))
    return 'Competitions | GSAI Admin Portal';
  if (pathname.startsWith('/admin/dashboard/blogs'))
    return 'Blogs | GSAI Admin Portal';
  if (pathname.startsWith('/admin/dashboard/news'))
    return 'News | GSAI Admin Portal';
  if (pathname.startsWith('/admin/dashboard/gallery'))
    return 'Gallery | GSAI Admin Portal';
  if (pathname.startsWith('/admin/dashboard/testimonials'))
    return 'Testimonials | GSAI Admin Portal';
  if (pathname.startsWith('/admin/dashboard/announcements'))
    return 'Announcements | GSAI Admin Portal';
  if (pathname.startsWith('/admin/dashboard/about'))
    return 'About Academy | GSAI Admin Portal';
...
function resolveRouteTitle(pathname: string): string {
  ...
  if (pathname === '/locations/lucknow')
    return 'Lucknow Martial Arts Training | GSAI';
  ...
  if (pathname === '/student/dashboard')
    return 'Student Dashboard | GSAI Portal';

  if (pathname === '/admin/login') return 'Admin Access | GSAI Security';
  if (pathname.startsWith('/admin/dashboard'))
    return getDashboardAdminTitle(pathname);
