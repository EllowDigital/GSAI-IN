...
const sections = [
  ...
  },
  {
    ...
    content: (
      <>
        Fees must be paid in full as per the selected program or membership plan.{" "}
        <strong>All fees are non-refundable</strong> under any circumstances, including withdrawal, relocation, illness, or disciplinary removal.
      </>
    ),
  },
  {
